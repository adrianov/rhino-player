...
/// Successive strained ticks (~1 Hz) before lowering ME budget or starting a busy-system pause.
const OVERLOAD_FIRE_STREAK_TICKS: u32 = 3;
...
const RECOVERY_STRAIN_TAIL_MIN_ELAPSED_SECS: f64 = 1.5;
