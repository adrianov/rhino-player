// Neighbour-search scoring: padded character trigrams + Jaccard (feature 33).

use std::collections::HashSet;

/// Minimum Jaccard similarity for a non-substring hit (feature 33).
pub(super) const TRIGRAM_MIN_SCORE: f64 = 0.3;
...
pub(super) fn name_match_score(name_lower: &str, q: &str, q_tri: &HashSet<Trigram>) -> Option<f64> {
    ...
    let score = jaccard(q_tri, &char_trigrams(name_lower));
