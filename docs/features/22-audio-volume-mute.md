...
## Notes
- Trough click + drag uses stock GtkRange behavior via `gtk-primary-button-warps-slider` in `theme::apply` (bottom seek bar and volume popover scale; Homebrew macOS often leaves this off by default).
