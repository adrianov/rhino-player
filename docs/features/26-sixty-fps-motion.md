...
Feature: Optional ~60 fps motion via VapourSynth
  ...
  Scenario: Sustained elevated smooth-playback strain rate lowers the saved pixel budget
    ...
    When presentation strain at the output exceeds about twenty percent of the pacing reference over a short trailing window for about two successive transport-heartbeat evaluations
  ...
  Scenario: Busy-system pause may return if overload comes back
    ...
    When presentation strain again exceeds about twenty percent of the pacing reference for about two successive transport-heartbeat evaluations
