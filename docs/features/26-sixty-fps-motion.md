...
- The vf line is `vapoursynth:file=…:buffered-frames=16:concurrent-frames=auto` (fixed queue depth). From **`min(width,height)`**: **≤1440** (**hd** tier): **16×8**, **`pel=2`**, **`sharp=2`**, **`search=4`**, **`truemotion=True`**, **`Super.chroma` off**, **`FlowFPS`** **`mask=2`**, **`blend=True`**, **`Super`** **`levels=6`**; **>1440** (**uhd** tier): **64×32**, **`pel=1`**, **`sharp=1`**, **`search=4`**, **`FlowFPS`** **`mask=2`**, **`Super`** **`levels=4`**, **`truemotion=True`**, **`blend=True`**, **`chroma` off**. Stderr logs **`tier=`** plus parameters.
